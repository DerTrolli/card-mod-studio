...
node preview_picker_check.mjs  # v0.9.0: click-to-edit picker (geometric hit-test finds the tile icon behind HA's tap layer, label + jump-to-module, overlay consumes clicks)
