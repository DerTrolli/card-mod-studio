...
3. Go to **Settings → Dashboards → ⋮ → Resources → + Add Resource**
   - URL: `/local/card-mod-studio.js?v=0.7.0-beta.3`
...
| 14 | Threshold Colors "Fade" (gradient) mode — smooth value→color interpolation as an alternative to discrete step rules | 🧪 v0.7.0-beta.3 (pre-release) |
